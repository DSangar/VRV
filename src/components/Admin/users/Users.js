...
import AddUserModal from "../users/AddUsers";
              ...
              <TableBody >
                {currentUsers.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td>
                      <Button variant="outline-info" onClick={() => handleEditUser(user)}>
                        <ActionIcon>
                          <EditIcon />
                          Edit
                        </ActionIcon>
            ...
            <CardContent>
              <CardLowerWrap>
                ...
                <div>
                  ...
                  <Button variant="outline-info" onClick={() => handleDeleteUser(user.id)}>
                    <ActionIcon>
                      <DeleteIcon />
                      Delete
                    </ActionIcon>
